    ...
    routes: [
      GoRoute(
        ...
        pageBuilder: (context, state) =>
            FadeTransitionPage(child: const ManagementScreen(), routes: const []),
        /*routes: [
          // Sub-rute dari Home
          GoRoute(
            path: 'products', // Path relatif: /products
  ...
  StatefulShellBranch(
    routes: [
      GoRoute(
        ...
        pageBuilder: (context, state) =>
            FadeTransitionPage(child: const SellerScreen(), routes: const []),
        //routes: commonDetailRoutes,
      ),
    ],
  ),
  ...
  StatefulShellBranch(
    routes: [
      GoRoute(
        ...
        pageBuilder: (context, state) =>
            FadeTransitionPage(child: const AttendanceScreen(), routes: const []),
        routes: commonDetailRoutes,
      ),
    ],
  ),

...
class AppNavigatorDrawer extends StatelessWidget {
  const AppNavigatorDrawer({super.key, required void Function(String route) onDrawerItemTap, required void Function(int index, String route) onDrawerItemTapAndClose});

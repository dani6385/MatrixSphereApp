...
import '../stream_screen.dart'; // 1. PASTIKAN IMPORT StreamSCREEN
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      leading: IconButton(
        ...
        onPressed: () {
          // Membuka laci secara paksa menggunakan GlobalKey milik StreamScreen
          StreamScreen.scaffoldKey.currentState?.openDrawer();
        },
      ),

...
/// Widget untuk menampilkan kartu header dengan sapaan.
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              'Halo, ${context.watch<AppViewModel>().ownerName}! Silakan lakukan absensi kehadiran harian Anda.',
...
/// Widget untuk menampilkan antarmuka pemindaian atau permintaan izin.
class _ScanningInterface extends StatelessWidget {
  final bool hasCameraPermission;
  final CameraController? cameraController;
  final Animation<double> laserAnimation;
  final String scanStatusMessage;
  ...
  const _ScanningInterface(
      {required this.hasCameraPermission, this.cameraController, required this.laserAnimation, required this.scanStatusMessage, required this.scanProgress, required this.onCancelScan, required this.onRequestPermission});
  ...
  /// Tampilan pemindai aktif dengan preview kamera dan overlay.
  ...
  /// Tampilan untuk meminta izin kamera.
...
/// Widget untuk menampilkan tombol aksi "Absen Masuk" dan "Absen Pulang".
class _ActionButtons extends StatelessWidget {
  ...
  /// Helper untuk membuat satu tombol aksi.

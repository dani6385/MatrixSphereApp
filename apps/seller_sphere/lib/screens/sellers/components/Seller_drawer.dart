// lib/navigation/widgets/app_Seller_drawer.dart

import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:shared_ui/shared_ui.dart';
import 'items/seller_drawer_items.dart'; // Impor data menu yang sudah dipecah
      ...
      header: const DrawerHeader(
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(
              Icons
                  .storefront, // Kamu bisa mengganti ikon ini sesuai kebutuhan (misal: Icons.account_circle)
              size: 48, // Ukuran ikon
              color: Colors

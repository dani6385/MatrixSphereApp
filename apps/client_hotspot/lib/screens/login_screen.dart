...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      await AuthService.setLoggedIn(true, _usernameController.text);
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text("MATRIX SPHERE", style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
              const Text("Sistem Akses Jaringan Terintegrasi", style: TextStyle(color: Colors.white70)),
              const SizedBox(height: 40),

              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  _buildMethodButton("Voucher", Icons.confirmation_number, () => _showInput('voucher')),
                  const SizedBox(width: 10),
                  _buildMethodButton("Member", Icons.person, () => _showInput('member')),
                ],
              ),
              ...
              if (_selectedMethod.isNotEmpty) ...[
                ...
                const Text("Silakan pilih metode login di atas.", style: TextStyle(color: Colors.white54)),
            ],
          ),
        ),
      ),

...
import 'package:shop_sphere/navigation/app_navigator.dart';
import 'package:shop_sphere/navigation/custom_transition_page.dart';
    ...
    StatefulShellRoute.indexedStack(
      ...
      branches: <StatefulShellBranch>[
        ...
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: AppRoutes.shops, // path: '/Shops'
              pageBuilder: (context, state) => FadeTransitionPage(
